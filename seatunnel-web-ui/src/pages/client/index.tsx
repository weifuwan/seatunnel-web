                        ...
                        <div className="min-w-0">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="min-w-0">
                              ...
                              <p className="max-w-[840px] text-[14px] leading-7 text-[#667085]">
                                <span className="mr-1.5 inline-flex items-center px-2.5 py-0.5 text-[14px] font-semibold text-[#4F46E5] ">
                                  「 大佬 」
                                </span>
                                来看看当前客户端的表现吧 👀
                              </p>
