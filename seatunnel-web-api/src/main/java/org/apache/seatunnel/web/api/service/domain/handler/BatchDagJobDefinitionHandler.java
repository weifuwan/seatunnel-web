...
@Component
public class BatchDagJobDefinitionHandler extends AbstractJsonSupport implements JobDefinitionHandler {
    ...
    public String buildHoconConfig(BaseJobDefinitionCommand command) {
        return jobConfigBuildService.buildBatchDagConfig(command);
    }
}