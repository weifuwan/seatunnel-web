package org.apache.seatunnel.web.dao.datasource;
...
public class SpringConnectionFactory {
    ...
    /**
     * Inject this field to make sure the database is initialized
     */
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource, GlobalConfig globalConfig,
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("org.apache.seatunnel.web.dao.entity");
        ResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        sqlSessionFactoryBean
                .setMapperLocations(resolver.getResources("org/apache/seatunnel/web/dao/mapper/*Mapper.xml"));
