...
INSERT INTO seatunnel_web.t_seatunnel_time_variable
(id, param_name, param_desc, variable_source, value_type, time_format, default_value, expression, example_value,
 enabled, remark, create_time, update_time)
VALUES (10001, 'now', '当前时间', 'SYSTEM', 'DYNAMIC', 'yyyy-MM-dd HH:mm:ss', NULL, 'now', '2026-05-02 09:30:00', 1,
        '系统内置变量', '2026-05-02 20:34:31', '2026-05-02 20:34:31');
INSERT INTO seatunnel_web.t_seatunnel_time_variable
(id, param_name, param_desc, variable_source, value_type, time_format, default_value, expression, example_value,
 enabled, remark, create_time, update_time)
VALUES (10002, 'today', '今天零点', 'SYSTEM', 'DYNAMIC', 'yyyy-MM-dd HH:mm:ss', NULL, 'today', '2026-05-02 00:00:00', 1,
        '系统内置变量', '2026-05-02 20:34:31', '2026-05-02 20:34:31');
INSERT INTO seatunnel_web.t_seatunnel_time_variable
(id, param_name, param_desc, variable_source, value_type, time_format, default_value, expression, example_value,
 enabled, remark, create_time, update_time)
VALUES (10003, 'biz_date', '业务日期，默认取调度时间的前一天', 'SYSTEM', 'DYNAMIC', 'yyyy-MM-dd', NULL, 'schedule_time-1d',
        '2026-05-01', 1, '系统内置变量', '2026-05-02 20:34:31', '2026-05-02 20:34:31');
INSERT INTO seatunnel_web.t_seatunnel_time_variable
(id, param_name, param_desc, variable_source, value_type, time_format, default_value, expression, example_value,
 enabled, remark, create_time, update_time)
VALUES (10004, 'start_time', '同步开始时间，默认取调度时间前一天零点', 'SYSTEM', 'DYNAMIC', 'yyyy-MM-dd HH:mm:ss', NULL,
        'schedule_time-1d@day_start', '2026-05-01 00:00:00', 1, '系统内置变量', '2026-05-02 20:34:31', '2026-05-02 20:34:31');
INSERT INTO seatunnel_web.t_seatunnel_time_variable
(id, param_name, param_desc, variable_source, value_type, time_format, default_value, expression, example_value,
 enabled, remark, create_time, update_time)
VALUES (10005, 'end_time', '同步结束时间，默认取调度当天零点', 'SYSTEM', 'DYNAMIC', 'yyyy-MM-dd HH:mm:ss', NULL,
        'schedule_time@day_start', '2026-05-02 00:00:00', 1, '系统内置变量', '2026-05-02 20:34:31', '2026-05-02 20:34:31');
